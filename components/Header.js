...
const styles = {
    ...
    headerWapper : 'flex justify-center h-full max-w-screen-xL mx-auto px-4',
    nav: 'flex justif-center items-center gap-[20px]',
    navItem: 'relative mr-1 cursor-pinter hover:opacity-60',
      ...
      <div className={styles.headerWapper}>
        <nav className={styles.nav}>
            <div className={styles.navItem}>
                <div className={styles.navLink}>CryptoSurrencies</div>
